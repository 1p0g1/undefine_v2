-- Migration: 20241201000004_clean_test_data_insert
-- Description: Clean test data insert without any ON CONFLICT dependencies
-- Author: Project Team
-- Date: 2024-12-01

-- Insert test players using WHERE NOT EXISTS to avoid conflicts
...
-- Insert user_stats using WHERE NOT EXISTS
...
-- Insert leaderboard_summary using WHERE NOT EXISTS  
...
-- Insert scores using WHERE NOT EXISTS
