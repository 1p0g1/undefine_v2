...
-- Migration: 20250702000001_fix_player_streaks_trigger.sql
-- Issue: Current trigger only counts daily consecutive wins, missing Beth's 8-win streak
-- Solution: Improve trigger to handle leaderboard-context consecutive wins with weekly gaps
...
-- This will fix Beth's streak and any other affected players
...
-- Verify Beth's streak is now correct
SELECT 
  'Beth streak verification' as test,
  current_streak,
  highest_streak,
  streak_start_date,
  last_win_date
