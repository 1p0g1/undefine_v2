-- Simple Strict Consecutive Daily Streak System
-- Date: January 25, 2025
-- No complex backup/restore - just direct implementation
...
-- Step 2: Simple recalculation function (no backup complexity)
...
BEGIN
  ...
  LOOP
    ...
    -- Update final streak data for this player (preserve highest_streak)
    UPDATE player_streaks SET
      current_streak = current_streak,
      highest_streak = GREATEST(player_streaks.highest_streak, highest_streak),
